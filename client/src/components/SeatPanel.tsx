  ...
  return (
    <div style={{ ...baseStyle, ...posStyle }}>
      <img
        ...
        style={{ width: compact ? 24 : 36, height: compact ? 24 : 36, borderRadius: 6, objectFit: "cover", border: "1px solid #666", background: "#ddd" }}
      />
      <div style={{ fontWeight: 700, color: "#2b241f", fontSize: compact ? 12 : 14 }}>{nickname || "Player"}</div>
      {(teamLabel || teamIndex !== undefined) && (
        <span
          className={
            `ml-2 px-2 py-0.5 text-[11px] rounded-full shadow-caféGlow ${

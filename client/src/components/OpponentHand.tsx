...
export default function OpponentHand({ position, count = 3 }: Props) {
  ...
  const posStyle: React.CSSProperties =
    position === "top"
      ...
      : position === "left"
      ? { left: 0, top: "50%", transform: "translateY(-50%)", flexDirection: "column", padding: isSmall ? 8 : 12 }
      : { right: 0, top: "50%", transform: "translateY(-50%)", flexDirection: "column", padding: isSmall ? 8 : 12 };

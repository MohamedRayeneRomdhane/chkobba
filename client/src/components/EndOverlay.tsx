            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 chalk-text">
              {scores && (
                <div className="text-left p-2">
                  ...
                  <div className="text-xl">Winner: {scores[0] === scores[1] ? "Tie" : scores[0] > scores[1] ? "Team A" : "Team B"}</div>
                </div>
              )}
              ...
              {details && (
                <div className="text-left p-2">
                  ...
                  <ul className="space-y-1 text-base">
                    <li>Karta (most cards): {details?.mostCards === 0 ? "Team A" : details?.mostCards === 1 ? "Team B" : "—"}</li>
                    <li>Dineri (most diamonds): {details?.mostDiamonds === 0 ? "Team A" : details?.mostDiamonds === 1 ? "Team B" : "—"}</li>
                    <li>Elhaya (7♦): {details?.sevenDiamonds === 0 ? "Team A" : details?.sevenDiamonds === 1 ? "Team B" : "—"}</li>
                    <li>Chkobbas: Team A {details?.chkobba?.[0] ?? 0} • Team B {details?.chkobba?.[1] ?? 0}</li>
                    <li>Bermila (tie-break by 6s): {details?.mostSevens === 0 ? "Team A" : details?.mostSevens === 1 ? "Team B" : details?.mostSevens === "tie" ? "Tie" : "—"}</li>
                  </ul>
                </div>
              )}
            </div>
